...
module.exports = (req, res) => {
  ...
  const productDeliveryAddress = req.body.productDeliveryAddress;
    ...
    console.log("Calling ------------------------------------------------------------");
     ...
     try{
         if(parseInt(obj[key]) !== undefined && obj[key].sig === listingSignature){
           ...
           obj[key].status1SendProductDeliveryAddressForm = true;
           obj[key].status0NextStatus = "AcceptProductDeliveryAddressForm";
           obj[key].productDeliveryAddress = productDeliveryAddress;
